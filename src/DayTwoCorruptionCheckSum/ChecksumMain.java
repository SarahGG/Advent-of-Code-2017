...
public class ChecksumMain {
    public static void main(String[] args) {
        String spreadsheetString = "1208\t412\t743\t57\t1097\t53\t71\t1029\t719\t133\t258\t69\t1104\t373\t367\t365\n" +
        ...
        System.out.println("checksum is " + Calculator.getChecksum(spreadsheet));
